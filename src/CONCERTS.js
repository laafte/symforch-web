const CONCERTS = [
    ...
    },
    {
        ...
        banner: "til_lands_til_vanns.jpg",
        credit: "Foto: foto.samfundet.no",
        when: "Våren 2023 en gang",
        iso8601: "2023-04-16",
        where: "Studentersamfundet",
        tickets: "https://www.uka.no/program/858-symforch-presenterer/1222/",
        conductor: "Gavin David Lee",
        description: "Symforch byr deg i høst på en reise til verdens mange varierte og vakre landskap. Gjennom repertoaret omsettes inntrykk helt fra skotske fjell og fjorder, via sentralasiatiske stepper, til romerske furutrær i en inntrykksfull og innbydende konsertopplevelse. Ta med en venn og bli med komponistene MacCunn, Borodin, Rautavaara, Delius og Respighi på en reise lengre enn du trodde var mulig på to timer.",
    },
    {
        title: "Festkonsert",
        banner: "festkonsert_banner.jpg",
        credit: "Foto: foto.samfundet.no",
        when: "6. oktober kl. 20:00",
        iso8601: "2022-10-06",
        where: "Studentersamfundet",
        tickets: "",
        conductor: "Gavin David Lee",
        description: "1910 startet en gruppe studenter og musikere i Trondheim sitt eget musikalorkester. I løpet av tiden vokste vi, og ble fort et fullt symfoniorkester som har funnet sitt hjem i Storsalen. I 2020 ble vi hele 110år! Dette måtte vi selvfølgelig feire slik vi liker best: med en staselig festkonsert. https://youtu.be/OEVUkf47IPA",
    }
];
